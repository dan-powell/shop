                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @foreach($itemsGrouped as $itemGroup)
                            ...
                            @include('shop::front.cartItem.excerpt.partials.itemGroup', ['itemGroup' => $itemGroup, 'editable' => true, 'images' => true])
                                        ...
                                        <table class="table table-striped table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($itemGroup->cartItems as $item)
                                                    @include('shop::front.cartItem.excerpt.partials.itemRow', ['item' => $item])
                                                @endforeach
