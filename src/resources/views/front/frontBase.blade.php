...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/holder/2.9.1/holder.js" defer></script>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="@if(Request::segment(1) == '')active @endif"><a href="{{ url() }}">Home <span class="sr-only">(current)</span></a></li>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-3">
            @include('shop::front.components.sidebar.sidebar')
        </div>
        <div class="col-sm-9">

            @include('shop::front.components.messages.messages')
