...
class ApiProjectsTest extends TestCase
{
    ...
    {
        // Setup
        $project = factory(DanPowell\Shop\Models\Project::class)->create();
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Project::class)->create();
    ...
    {
        // Setup
        $project = factory(DanPowell\Shop\Models\Project::class)->make();
    ...
    public function testResponsePutProject()
    {
        // Setup
        $project = factory(DanPowell\Shop\Models\Project::class)->create();
        $newProject = factory(DanPowell\Shop\Models\Project::class)->make();
        $user = factory(App\User::class)->create();
    ...
    {
        // Setup
        $persistentModel = factory(DanPowell\Shop\Models\Project::class)->create();
        $model = factory(DanPowell\Shop\Models\Project::class)->make();
    ...
    {
        // Setup
        $section = factory(DanPowell\Shop\Models\Section::class)->make();
        $project = factory(DanPowell\Shop\Models\Project::class)->create();
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Section::class)->make();
    ...
    {
        // Setup
        $page = factory(DanPowell\Shop\Models\Page::class)->make();
        $project = factory(DanPowell\Shop\Models\Project::class)->create();
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Page::class)->make();
