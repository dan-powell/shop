...
class ApiPagesTest extends TestCase
{
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Page::class)->create();
...
*/
    ...
    public function testResponsePutPage()
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Page::class)->create();
        $newModel = factory(DanPowell\Shop\Models\Page::class)->make();
        $user = factory(App\User::class)->create();
    ...
    {
        // Setup
        $persistentModel = factory(DanPowell\Shop\Models\Page::class)->create();
        $model = factory(DanPowell\Shop\Models\Page::class)->make();
    ...
    {
        // Setup
        $relation = factory(DanPowell\Shop\Models\Section::class)->make();
        $model = factory(DanPowell\Shop\Models\Page::class)->create();
