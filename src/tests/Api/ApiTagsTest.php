...
class ApiTagsTest extends TestCase
{
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Tag::class)->create();
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Tag::class)->make();
    ...
    public function testResponsePutTag()
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Tag::class)->create();
        $newModel = factory(DanPowell\Shop\Models\Tag::class)->make();
        $user = factory(App\User::class)->create();
    ...
    {
        // Setup
        $persistentModel = factory(DanPowell\Shop\Models\Tag::class)->create();
        $model = factory(DanPowell\Shop\Models\Tag::class)->make();
    ...
    {
        // Setup
        $model = factory(DanPowell\Shop\Models\Tag::class, 10)->create();
